  ...
  return (
    ...
    >
      ...
      <motion.div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4" variants={stagger}>
        ...
        <motion.div variants={item}>
          <StatCard title="Active Outlets" value={activeOutlets} delta="" icon={<Store className="h-5 w-5 text-emerald-500" />} />
        </motion.div>
        <motion.div variants={item}>
          <StatCard title="Trial Outlets" value={trialOutlets} delta="" icon={<Store className="h-5 w-5 text-blue-500" />} />
        </motion.div>
        <motion.div variants={item}>
          <StatCard title="Paid Outlets" value={paidOutlets} delta="" icon={<Store className="h-5 w-5 text-indigo-500" />} />
        </motion.div>
        
        <motion.div variants={item}>
          <StatCard title="Churn Risk" value={churnRiskOutlets} delta="< 50% usage" icon={<TriangleAlert className="h-5 w-5 text-amber-500" />} />
        </motion.div>
        <motion.div variants={item}>
          <StatCard title="Churned Outlets" value={churnOutlets} delta="Not renewed" icon={<TriangleAlert className="h-5 w-5 text-rose-500" />} />
        </motion.div>
        <motion.div variants={item}>
        ...
        <motion.div variants={item}>
          <StatCard title="Est. Burn (AI/WA)" value={`$${estimatedBurn.toFixed(2)}`} delta="" icon={<TriangleAlert className="h-5 w-5 text-rose-500" />} />
        </motion.div>
        <motion.div variants={item}>
